...
def submit():
    ...
    sheet.cell(column=1,row=sheet.max_row,value=contact)
    sheet.cell(column=1,row=sheet.max_row,value=age)
    sheet.cell(column=1,row=sheet.max_row,value=gender)
    sheet.cell(column=1,row=sheet.max_row,value=address)
